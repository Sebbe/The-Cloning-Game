...
{
    public class Door : GameObjectCollidable
    {
        ...
        public Door(Game baseGame, SpriteBatch spriteBatchToUse, Vector2 position)
            : base(position)
        {
        ...
        {
            Art = game.Content.Load<Texture2D>(@"Pictures/door");
